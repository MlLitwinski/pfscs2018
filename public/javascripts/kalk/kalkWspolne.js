...
// Początek funkcjonalności 
function inputAutoSize() {
    var inputStawki = document.querySelectorAll('.inputAutoSize');
    for (var i = 0; i < inputStawki.length; i++) {
        var zawartosc = inputStawki[i].value.length;
        inputStawki[i].style.width = (zawartosc*11)+"px";
    }
};
